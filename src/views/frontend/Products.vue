            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="carousel-img-1 bg-cover">
                  <div class="carousel-caption d-none d-sm-block carousel-caption-text">
                      <!-- <h2 class="">果汁。沙拉。優格</h2> -->
    ...
    <div class="container products-info">
      <div class="products-info-category mt-5">
        <ul class="d-flex list-unstyled m-0 p-0">
          <li class="text-center" :class="{active: category == 'all'}">
          ...
          <li class="text-center" :class="{active: category == '經典商品'}">
            <a href="#" class="products-list"
          ...
          <li class="text-center" :class="{active: category == '活力果汁'}">
            <a href="#" class="products-list"
          ...
          <li class="text-center" :class="{active: category == '營養沙拉'}">
            <a href="#" class="products-list"
          ...
          <li class="text-center" :class="{active: category == '酸甜優格'}">
            <a href="#" class="products-list"
      ...
      <div class="outline">
        ...
        <div class="d-flex justify-content-center">
          <Pagination :pageData="pagination"
                      @emitpage="getAllProducts" @scrollTarget="scroll"
                      v-if="category=='all'">
          </Pagination>
        </div>
      </div>
